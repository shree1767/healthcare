...
const Navbar = () => {
  return (
    <nav className="flex flex-col sm:flex-row items-center justify-between py-4 px-8 bg-[#006797] text-white">
      ...
      <div className="searchbar flex items-center bg-[#F4F4F4] rounded-[25px] w-full sm:w-[50vw] h-[7vh] mt-4 sm:mt-0">
        ...
        <input
          type="text"
          placeholder="Search"
          className="py-2 pl-2 pr-4 bg-[#F4F4F4] rounded-[25px] text-[#858585] focus:outline-none w-full"
        />
      </div>
      <div className="flex space-x-5 items-center mt-4 sm:mt-0">
        ...
        <div className="user-dropdown relative">
          ...
          <button className="flex space-x-2 items-center focus:outline-none">
            <img src={userico} alt="User" className="md:w-full w-6" />
