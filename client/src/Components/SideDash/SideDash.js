...
const SideDash = () => {
  const links = [
    { id: 1, title: 'Overview',image:overview},
    { id: 2, title: 'Patients', image:patients},
    { id: 3, title: 'Messages',image:messages },
    { id: 4, title: 'Settings',image:settings},
  ];

  return (
    <nav className="flex flex-col m-10 text-[30px] rounded-lg justify-between bg-[#006797] text-white h-[75vh] w-[20vw] pl-4 py-4">
      <ul className="space-y-2 font-bold pt-5">
        {links.map((link) => (
          <li
            key={link.id}
