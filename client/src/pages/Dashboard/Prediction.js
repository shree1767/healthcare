        ...
        <div className='text-[25px]'>
          <div>
            ...
            <input
              type='date'
              name='date'
              className='p-2 mx-2 mb-3 bg-white border border-[#006797] border-[2px] rounded'
              placeholder='Date'
            />
          </div>
          <div>
            ...
            <input
              ...
              className='w-[10vw] text-[#006797] mx-1 p-2 mb-3 border border-[#006797] border-[2px] rounded'
            />
          </div>
        </div>
      </div>
