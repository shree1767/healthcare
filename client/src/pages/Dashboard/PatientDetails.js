  ...
  return (
    <div className="pt-5 px-5 h-screen overflow-y-auto">
      <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-10">
        <Link
          to="/patients"
          className="bg-[#455B5D] mx-auto md:mx-0 w-1/2 md:w-[15vw] md:h-[6vh] py-[1vh] text-white md:text-[20px] font-[700] text-center rounded-lg"
        >
          Patient List
        </Link>
      ...
      <div className="rounded-lg bg-[#D6EDEF] py-8 md:px-8 px-2 my-2 grid md:grid-cols-4 gap-2 md:text-[20px]">
        ...
        <div className="">
          <div className="flex space-x-5 bg-white rounded-lg items-center text-center w-[45vw] md:w-[23vw] px-5 py-3 mb-2">
